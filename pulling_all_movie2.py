        ...
        while True:
            try:
                ...
                cursor.execute(
                    ...
                    " ,(SELECT (json_data -> 'total_pages')::integer FROM movie_by_page as im WHERE im.value1 = om.value1 and (json_data -> 'total_pages') IS NOT NULL ORDER BY value2::int DESC LIMIT 1) AS totalpages"
